...
// app/javascript/avo_calendar.js
document.addEventListener("DOMContentLoaded", function() {
  ...
  function fetchEvents(type) {
    ...
    return function(info, successCallback, failureCallback) {
      fetch(url).then((response) => response.json()).then((data) => successCallback(data)).catch((error) => {
...
//# sourceMappingURL=/assets/avo_calendar.js.map
